    ...
    <form action={handleSubmit}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              className="peer block w-full rounded-md border border-gray-200 bg-white py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
              required
            >
        ...
        <fieldset>
          ...
          <div className="rounded-md border border-gray-200 bg-white px-[16px] py-[9px]">
